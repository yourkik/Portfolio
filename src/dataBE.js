...
// TODO: 반려동물 산책로 추천 시스템 이미지 추가
// import petRouteSystem from './assets/pet-route-system.png';
  ...
  projects: [
    {
      ...
      tags: ["Python", "FastAPI", "Databricks", "Azure", "GitHub Actions"],
      ...
      image: null, // 추후 petRouteSystem 으로 변경
      links: [
